...
public class UniversityGroup {
    ...
    String getGroupDiscription() {
        String discription = String.format("%s start %d end %d students: ", groupName, startYear, endYear);
        for (int i = 0; i < studentsArray.length; i++) {
            discription = discription + studentsArray[i] + ", ";
        }
        return discription;
    }
    ...
    public static void main(String[] args) {
        String[] studentJava = new String[] {"Mayson Maunt", "Rise James"};
        ...
        String[] studentQA = new String[] {"Timo Werner", "Kai Havertz", "N'Golo Kante"};
